...
<body>
    <table style="width: 100%">
        <tr class="parent"><td colspan="8" style="font-size:24px; font-weight:bold">LAPORAN MATERIAL &amp; ALAT MINGGU INI MASUK</td></tr>
        ...
        <tr class="item header" style="background-color: #dddddd; text-align: center;">
            ...
            <td style="width: 200px; border: 1px solid black; text-align:center; font-weight:bold;" bgcolor="#ddddddd">Supplier dan No. PO</td>
            <td style="width: 270px; border: 1px solid black; text-align:center; font-weight:bold;" bgcolor="#ddddddd">Keterangan</td>
        </tr>
        @foreach ($datas as $index => $item)
            @php
                $itemData = $item->deliveryOrderItem->materialRequestItem->item ?? null;
                $uom = $itemData->uom->name ?? '-';
            @endphp
            <tr class="item">
                <td style="border: 1px solid black; text-align:center;">{{$index + 1}}</td>
                <td style="border: 1px solid black; text-align:center;">{{$item->arrival_date}}</td>
                ...
                <td style="border: 1px solid black; text-align:center; font-weight:bold;">{{$item->remark ?? ''}}</td>
            </tr>
        @endforeach
        ...
        <tr class="item">
            ...
            <td style="border: 1px solid black; text-align:center; white-space: nowrap">Diperiksa Oleh</td>
